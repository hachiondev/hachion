    ...
    const fetchGeolocationData = async () => {
      try {
        const geoResponse = await axios.get(
          "https://ipinfo.io?token=9da91c409ab4b2"
        );
        ...
        console.error(
          "Error fetching geolocation or exchange rate data:",
          error
        );
            ...
            <div className="qa-automation-left">
              ...
              <div className="qa-automation-middle">
                ...
                <h6 className="sidebar-course-review">
                  Rating: {course.starRating} {renderStars(course.starRating)} (
                  {course.ratingByNumberOfPeople})
                </h6>
              </div>
            </div>
            <div
