...
//	List<Object[]> findDiscountByCouponCode(@Param("couponCode") String couponCode);
	...
	@Query(value = "SELECT discount_type, discount_value, country_names, end_date, usage_limit, number_of_hits, course_names "
			+ "FROM coupon_code " + "WHERE coupon_code = :couponCode AND status = 'Active'", nativeQuery = true)
	List<Object[]> findDiscountByCouponCode(@Param("couponCode") String couponCode);
