...
const SalWorkshop = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Best Salesforce Training & Workshop in USA | Expert Guidance
        </title>
        <meta
          name="description"
          content="Unlock your potential with our expert-led Salesforce training & workshop in USA. Enhance skills, boost career & transform businesses."
        />
        <meta
          name="keywords"
          content="Salesforce Training, Salesforce Workshop, USA Salesforce Training, Expert Guidance, Career Development"
        />
      </Helmet>
      <Topbar />
      <NavbarTop />
      <div className="course-top">
        ...
        <div className="workshop-banner" onClick={handleScrollToWorkshop}>
          <p className="workshop-banner-content">
            Register Now Before Seats Run Out !
          </p>
          <button className="join" onClick={handleScrollToWorkshop}>
            Join Now
          </button>
        </div>
