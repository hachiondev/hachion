    ...
    setFormData((prevData) => {
      ...
      modes.forEach((mode) => {
        ...
        if (hasAmount && hasDiscount && !hasTotal) {
          updatedData[totalKey] = Math.round(
            amount - (amount * discount) / 100
          );
        } else if (hasAmount && hasTotal && !hasDiscount && amount !== 0) {
          updatedData[discountKey] = Math.round(
              ...
              <div class="mb-3" style={{ paddingBottom: "20px" }}>
                ...
                <ReactQuill
                  ...
                  onChange={(content) => {
                    ...
                    if (count > 360) {
                      setError(
                        "Character limit exceeded. Please keep it within 360 characters."
                      );
                    } else {
                      setError("");
                    }
                ...
                <div
                  style={{
                    ...
                    marginTop: "8px",
                    fontSize: "14px",
                    color: characterCount > 360 ? "red" : "black",
                  }}
                >
                ...
                <Table sx={{ minWidth: 700 }}>
                  ...
                  <TableBody>
                    {displayedCategories.length > 0 ? (
                      displayedCategories.map((course, idx) => (
