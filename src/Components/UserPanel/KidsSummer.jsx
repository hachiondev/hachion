  ...
  return (
    <div>
      ...
      <h1 className="summer-title">
        Best Summer Tech Bootcamp 2025 for Teens | Coding & Design Courses
      </h1>
      ...
      <div className="summer-part">
        <p className="summer-text">
          Give your child a head start in tech this summer! Our bootcamp teaches
          real-world tech skills through project-based learning, designed for
      ...
      <div className="summer-part">
        ...
        <ol>
          <li className="choose-points">
            ...
            Industry-Aligned Curriculum - Learn tools professionals use daily
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            Certification - Boost college applications & resumes
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            1:1 Mentorship - Dedicated instructor support
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            Fun & Interactive - No boring lectures!
          </li>
        </ol>
      </div>
      ...
      <div className="summer-part">
        <ol>
          <li className="choose-points">
            ...
            Early Bird Discount: 10% off until May 30
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <MdDiscount />
            </span>{" "}
            Sibling/Friend Group Discount: Extra 5% off
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <MdDiscount />
            </span>{" "}
            Free Demo Class: June 1st - Parents welcome!
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <MdDiscount />
            </span>{" "}
            Certificate + Project Showcase (Share on LinkedIn!)
          </li>
        </ol>
      ...
      <div className="summer-part">
        ...
        <ol>
          <li className="choose-points">
            ...
            Top-Rated Instructors - Silicon Valley-trained mentors
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            Project-Based Learning - Build real apps/websites
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            Career Prep - Resume workshop & tech showcase
          </li>
          <li className="choose-points">
            <span className="point-icon">
              <TbArrowBadgeRightFilled />
            </span>{" "}
            100% Satisfaction - Join 1,000+ happy students!
          </li>
        </ol>
      </div>
