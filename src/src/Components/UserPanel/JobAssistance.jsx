  ...
  const jobAssistanceItems = [
    {
      ...
      description: 'Placement opportunities are provided once the learner is moved to the placement pool upon clearing Placement Readiness Test (PRT)'
    },
    {
      image: accessImage,
      title: 'Exclusive access to Hachion Job portal',
      description: 'Exclusive access to our dedicated job portal and apply for jobs. More than 400 hiring partners’ including top start-ups and product companies hiring our learners. Mentored support on job search and relevant jobs for your career growth.',
