    ...
    <div className="footer">
      <div className="footer-top">
        ...
        <div className="footer-head">
          <p className="footer-heading">Hachion</p>
          <div className="footer-row">
            <p className="footer-content" onClick={handleAbout}>
              About us
            </p>
            <span>|</span>
            <p className="footer-content" onClick={handleContact}>
              Contact us
            </p>
            <span>|</span>
            <p className="footer-content">Careers</p>
            <span>|</span>
            <p className="footer-content" onClick={handleBlog}>
              Blog
            </p>
            <span>|</span>
            <p className="footer-content">Internship</p>
      ...
      <div className="footer-bottom">
        <div className="footer-p">
          <p className="footer-copyright">
            © Hachion 2024. All Rights Reserved.
          </p>
          <div className="term">
            <p className="footer-term" onClick={handleTerms}>
