...
const handleFileChange = (e) => {
    ...
    useEffect(() => {
      const fetchCertificate = async () => {
          try {
              const response = await axios.get('http://160.153.175.69:8080/certificate');
    ...
    const handleDeleteConfirmation = (id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `http://160.153.175.69:8080/banner/certificate/${editedData.id}`,editedData
            );
            setCertificate((prev) =>
                prev.map(curr =>
      ...
      const handleDelete = async (id) => {
         ...
         try { 
          const response = await axios.delete(`http://160.153.175.69:8080/certificate/delete/${id}`); 
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("http://160.153.175.69:8080/certificate/add", formData, {
                headers: {
