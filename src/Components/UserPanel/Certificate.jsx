    ...
    const fetchCertificates = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://api.hachion.co/certificate/byname/${studentName}`
        );
  ...
  return (
    <>
      <div className="courses-enrolled">
        <nav className="dashboard-nav">Download Certificate</nav>
      </div>
              ...
              <TableBody>
                {certificates.map((certificate, index) => (
                  <TableRow key={certificate.certificateId}>
                    ...
                    <TableCell align="center">
                      <a
                        href={`https://api.hachion.co/download/filename/${certificate.certificatePath.replace(
                          "certificates/",
                          ""
                        )}`}
                        target="_blank"
