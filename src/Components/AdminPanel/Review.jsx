...
export default function Review() {
  ...
  const [editedData, setEditedData] = useState({
    categoryName: "", course_name: "", student_name: "", image: null, rating: "", location: "", videoLink: "", trainer_name: "", type: "", source: "", comment: "", reviewType: "", display: "",
    displayPages: []
  });
  ...
  const handleSelectAll = (event) => {
    if (event.target.checked) {
      const allIds = displayedCategories.map(review => review.review_id);
  ...
  useEffect(() => {
    const allCurrentPageIds = displayedCategories.map(review => review.review_id);
                ...
                displayedCategories.map((curr, index) => (
                  <StyledTableRow key={curr.review_id}>
                    <StyledTableCell align="center">
                      <Checkbox
                        checked={selectedIds.includes(curr.review_id)}
                        onChange={() => handleSelectOne(curr.review_id)}
                      />
