  ...
  const handleSave = async () => {
    try {
      const response = await axios.put(
        `https://api.hachion.co/videoaccess/update/${editedData.resume_id}`,
        editedData
      );
      setResume((prev) =>
        prev.map((curr) =>
  ...
  const handleDelete = async (resume_id) => {
    try {
      const response = await axios.delete(
        `https://api.hachion.co/resume/delete/${resume_id}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://api.hachion.co/resume/add",
        dataToSubmit
      );
            ...
            <div className="course-details">
              <div className="course-row">
                <div class="col-md-3">
                  ...
                  <select
                    ...
                    class="form-select"
                    name="category_name"
                    value={resumeData.category_name}
              ...
              <div class="mb-6">
                <label for="exampleFormControlTextarea1" class="form-label">
                  Enter Junior level Position Path
                </label>
                <input
                  type="text"
                  id="inputtext6"
              ...
              <div class="mb-6">
                <label for="exampleFormControlTextarea1" class="form-label">
                  Enter middle level Position Path
                </label>
                <input
                  type="text"
                  id="inputtext6"
              ...
              <div class="mb-6">
                <label for="exampleFormControlTextarea1" class="form-label">
                  Enter senior level Position Path
                </label>
                <input
                  type="text"
                  id="inputtext6"
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCell align="center">
                    Junior level position link
                  </StyledTableCell>
                  <StyledTableCell align="center">
                    Middle level position link
                  </StyledTableCell>
                  <StyledTableCell align="center">
                    Senior level position link{" "}
                  </StyledTableCell>
                      ...
                      <StyledTableCell align="center">
                        ...
                        >
                          ...
                          <RiDeleteBin6Line
                            className="delete"
                            onClick={() =>
                              handleDeleteConfirmation(row.resume_id)
                            }
                          />
                        </div>
                      </StyledTableCell>
