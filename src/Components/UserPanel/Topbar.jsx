...
//         console.log('🌍 IP-based country:', country.country);
...
//         // Fallback to default values in case of error (e.g., rate-limited)
//         setWhatsappNumber('+1 (732) 485-2499');
//         setWhatsappLink('https://wa.me/17324852499');
//       }
//     };
...
//   useEffect(() => {
//     console.log('Whatsapp Number Updated:', whatsappNumber); // Log whenever whatsappNumber changes
//     console.log('Whatsapp Link Updated:', whatsappLink); // Log whenever whatsappLink changes
//   }, [whatsappNumber, whatsappLink]); // Trigger this effect when either whatsappNumber or whatsappLink changes
