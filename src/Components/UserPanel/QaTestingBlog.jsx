...
const handleDownload = () => {
  ...
  <meta property="og:image" content={selectedBlog?.blog_image ? `http://localhost:8080/blogs/${selectedBlog.blog_image}` : "https://hachion.co/images/course-banner.jpg"} />
  ...
  <>
    <div className='salesforce-middle'>
      <img src={`http://localhost:8080/blogs/${selectedBlog.blog_image}`} alt={selectedBlog.title} />
      <div>
