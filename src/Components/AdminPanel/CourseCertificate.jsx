...
const handleFileChange = (e) => {
    ...
    useEffect(() => {
      const fetchCertificate = async () => {
          try {
              const response = await axios.get('https://api.hachion.co/certificate/certificate');
    ...
    const handleDeleteConfirmation = (id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `https://api.hachion.co/certificate/certificate/${editedData.id}`,editedData
            );
            setCertificate((prev) =>
                prev.map(curr =>
      ...
      const handleDelete = async (id) => {
         ...
         try { 
          const response = await axios.delete(`https://api.hachion.co/certificate/certificate/delete/${id}`); 
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("https://api.hachion.co/certificate/certificate/add", formData, {
                headers: {
