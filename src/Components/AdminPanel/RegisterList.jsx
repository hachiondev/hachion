...
const [currentPage, setCurrentPage] = useState(1);
    ...
    const handleDeleteConfirmation = (student_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `http://160.153.175.69:8080/registerstudent/update/${editedData.student_id}`,editedData
            );
      ...
      const handleDelete = async (student_id) => {
         ...
         try { 
          const response = await axios.delete(`http://160.153.175.69:8080/registerstudent/delete/${student_id}`); 
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post("http://160.153.175.69:8080/registerstudent/add", dataToSubmit);
