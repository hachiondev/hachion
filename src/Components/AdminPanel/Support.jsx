  ...
  const [searchTerm,setSearchTerm]=useState("")
    ...
    useEffect(() => {
      const fetchSupport = async () => {
          try {
              const response = await axios.get('/HachionUserDashboad/support');
    ...
    const handleDeleteConfirmation = (support_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `/HachionUserDashboad/support/update/${editedData.support_id}`,editedData
            );
            setSupport((prev) =>
                prev.map(curr =>
      ...
      const handleDelete = async (support_id) => {
         ...
         try { 
          const response = await axios.delete(`/HachionUserDashboad/support/delete/${support_id}`); 
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post("/HachionUserDashboad/support/add", dataToSubmit);
