  ...
  const displayedCategories = filteredReview.slice(
    ...
    useEffect(() => {
      const fetchReview = async () => {
          try {
              const response = await axios.get('http://160.153.175.69:8080/HachionUserDashboad/review');
    ...
    //   };
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `http://160.153.175.69:8080/HachionUserDashboad/review/update/${editedData.review_id}`,editedData
            );
            setReview((prev) =>
                prev.map(curr =>
      ...
      const handleDelete = async (review_id) => {
         ...
         try { 
          const response = await axios.delete(`http://160.153.175.69:8080/HachionUserDashboad/review/delete/${review_id}`); 
    ...
    const handleChange = (e) => {
      ...
      console.log(review);
        ...
        try {
          const response = await axios.post("http://160.153.175.69:8080/HachionUserDashboad/review/add", dataToSubmit);
