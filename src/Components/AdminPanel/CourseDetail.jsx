...
const CourseDetail = ({
        ...
        updatedData[modeFields[name]] = calculateTotal(
          updatedData[
            name.includes("discount")
              ? name.replace("discount", "amount")
              : name
          ],
          updatedData[
            name.includes("amount") ? name.replace("amount", "discount") : name
          ]
        );
      }
  ...
  const handleSubmit = async (e) => {
    ...
    const courseData = {
      ...
      mamount: formData.mamount,
      mdiscount: formData.mdiscount,
      mtotal: formData.mtotal,
      samount: formData.samount,
      sdiscount: formData.sdiscount,
      stotal: formData.stotal,
      camount: formData.camount,
      cdiscount: formData.cdiscount,
      ctotal: formData.ctotal,
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          total: course.total,
          mamount: course.mamount,
          mdiscount: course.mdiscount,
          mtotal: course.mtotal,
          samount: course.samount,
          sdiscount: course.sdiscount,
          stotal: course.stotal,
          camount: course.camount,
          cdiscount: course.cdiscount,
          ctotal: course.ctotal,
            ...
            <div className="col-md-3">
              ...
              />
                ...
                <div className="course-row">
                  ...
                  <div class="col-md-4">
                    <label for="inputEmail4" class="form-label">
                      Course keyword description
                    </label>
                    <input
                      type="text"
                      class="form-control"
                      id="inputEmail4"
                      name="courseKeywordDescription"
                      value={formData.courseKeywordDescription}
                      onChange={handleInputChange}
                    />
                  </div>
                </div>
                <div class="mb-3" style={{ paddingBottom: "20px" }}>
                  <label for="exampleFormControlTextarea1" class="form-label">
                    Course Highlight(Only add 4 Lines)
                  </label>
  ...
  onChange={handleHighlightChange} */}
                  <ReactQuill
                    ...
                    onChange={(content) => {
                      ...
                      if (wordCount > 65) {
                        setError(
                          "Word limit exceeded. Please keep it within 65 words."
                        );
                      } else {
                        setError("");
  ...
  onChange={handleTextChange} */}
                  <ReactQuill
                    ...
                    value={formData.courseDescription}
                    onChange={(content) =>
                      handleInputChange(null, "courseDescription", content)
                    }
            ...
            <Helmet>
              ...
              <meta
                name="description"
                content={
                  formData.courseKeywordDescription || "Default Description"
                }
              />
              <meta
                name="keywords"
                content={formData.courseKeyword || "Default Keywords"}
              />
            </Helmet>
          </div>
        </div>
                ...
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                  <TableHead>
                    <TableRow>
                      ...
                      <StyledTableCell
                        sx={{ width: 150, fontSize: "16px" }}
                        align="center"
                      >
                        S.No.
                      </StyledTableCell>
                      <StyledTableCell
                        sx={{ width: 220, fontSize: "16px" }}
                        align="center"
                      >
                        Image
                      </StyledTableCell>
                          ...
                          >
                            ...
                            >
                              ...
                              <RiDeleteBin6Line
                                className="delete"
                                onClick={() =>
                                  handleDeleteConfirmation(course.id)
                                }
