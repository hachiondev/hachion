  ...
  useEffect(() => {
    const filtered = curriculum.filter(
      (curriculum) =>
        ...
        (curriculum.title?.toLowerCase() || "").includes(
          searchTerm.toLowerCase()
        ) ||
        (curriculum.topic?.toLowerCase() || "").includes(
          searchTerm.toLowerCase()
        )
    );
    setFilteredCurriculum(filtered);
                        ...
                        <StyledTableCell align="center">
                          ...
                          >
                            ...
                            <RiDeleteBin6Line
                              className="delete"
                              onClick={() =>
                                handleDeleteConfirmation(course.curriculum_id)
                              }
                            />
                          </div>
                        </StyledTableCell>
      ...
      >
        ...
        <DialogContent>
          ...
          <ReactQuill
            ...
            onChange={(value) =>
              setEditedRow((prevData) => ({ ...prevData, topic: value }))
            }
            modules={quillModules}
          />
