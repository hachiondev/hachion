        ...
        <div className="about-us-content">
          ...
          <div className="about-us-top">
            <p className="about-us-left-content">
              Hachion is an organization that has been set up with the purpose
              of bridging the gap between graduates and corporate. In terms of
              entry or multi level seniority the industry has been transforming
              very quickly. Traditional and conventional hiring practices are
              becoming obsolete in the dynamic economic conditions globally.
              Corporate have been benefiting from our Just-In-Time skilled
              resource pool which can be deployed and be market ready in just a
              few days than the campus pool being hired in the conventional
              method. Our content and delivery methodology adopt the best
              practices followed by the industry which focuses on equipping
              students with the necessary skills to succeed.
            </p>
            <img src={aboutUsSider} alt="" />
          </div>
          <p className="about-us-left-content">
            Our placement services focus on providing extensive end-to- end
            services as per the customized requirement of our clients enabling
            them to get the right candidates by helping them to save the time
            and resources. Identifying and sourcing candidates from our
            extensive network of clients and candidates who are engaged in
            similar business related to our clients as well as usage of various
            platforms enable us to find the right candidates at a quicker time
            frame along with the right fit to the requisite profile. We believe
            that the key to effective service is to truly understand from the
          ...
          <div className="about-us-top">
            <p className="about-us-left-content">
              ...
              requirement” and to see that quality manpower is constructively
              and appropriately channelized. To help talented and specialized
              individuals in building their own career and to ensure our clients
              find employees according to their specific requirements is a
              constant driving force in line with our vision. As a part of our
              mission we are aligned with various institutions from various
              regions aided by our expansive network to fetch formerly unexposed
              talents and avail them to our reputed clients.
            </p>
          ...
          <p className="about-us-left-content">
            ...
            to take you to the next level and increase your career
            opportunities. We are extremely passionate and committed to what we
          ...
          <p className="about-us-left-content">
            ...
            instructor-led online training programs...
          </p>
          <div className="about-us-div">
            ...
            <div className="about-us-div-content">
              ...
              <p>
                Positive feedback from participants and successful outcomes.
              </p>
            </div>
          </div>
        </div>
