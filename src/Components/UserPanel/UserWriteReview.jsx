...
const UserWriteReview = ({ setShowReviewForm, onSubmitReview }) => {
  ...
  useEffect(() => {
    axios.get('http://160.153.175.69:8080/HachionUserDashboad/courses/all')
      .then(response => {
    ...
    axios.get('http://160.153.175.69:8080/HachionUserDashboad/trainers')
      .then(response => {
  ...
  const handleSubmit = () => {
    ...
    axios.post('http://160.153.175.69:8080/HachionUserDashboad/userreview/add', reviewData)
      .then(response => {
