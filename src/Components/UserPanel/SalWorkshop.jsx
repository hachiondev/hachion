...
const SalWorkshop = () => {
  ...
  const convertISTtoLocalTime = (date, time, timeZone = "Asia/Kolkata") => {
    ...
    try {
      ...
      return {
        ...
        localTime,
        timeZone:
          timeZoneAbbreviationMap[userTimeZone] ||
          timeZoneAbbreviation ||
          "IST",
      };
    } catch {
  ...
  const handleSubmit = async (e) => {
    ...
    const currentDate = new Date().toISOString().split("T")[0];
    const timeZoneShort =
      timeZoneAbbreviationMap[resolvedTimeZone] || resolvedTimeZone || "IST";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={workshop?.meta_description || "Workshop description"}
        />
        <meta name="keywords" content={workshop?.meta_keyword || "workshop"} />
        <meta
          property="og:title"
          content={workshop?.meta_title || "Best Online IT Workshop Courses"}
        />
        <meta
          property="og:description"
          content={
            workshop?.meta_description ||
