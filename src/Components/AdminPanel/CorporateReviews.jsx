     ...
     {showAddCourse ?  (<div className='course-category'>
      <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                      ...
                      <a href="#!" onClick={() => setShowAddCourse(false)}>Corporate Review</a> <MdKeyboardArrowRight />
                      </li>
                      <li className="breadcrumb-item active" aria-current="page">
                        Add Corporate Review
                      </li>
                    </ol>
                  </nav>
<div className='category'>
<div className='category-header'>
<p style={{ marginBottom: 0 }}>Add Corporate Review</p>
</div>
...
<div className="course-row">
  ...
  <div className="dialog-title">
    <DialogTitle id="edit-schedule-dialog">Edit  Corporate Review</DialogTitle>
