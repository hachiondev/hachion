            ...
            <div className='Details-right'>
              <div className='Job-row'>
                <div className='Job-column'>
                  ...
                  <p className='Details-icon-text'><span className='Details-icon'><FaCalendarWeek /></span> Work : {workDays}</p>
                </div>
                <div className='Job-column'>
                  <p className='Details-icon-text'><span className='Details-icon'><MdAccessTimeFilled /></span> {time}</p>
                  <p className='Details-icon-text'><span className='Details-icon'><MdAccessTimeFilled /></span> Notice Period : {noticePeriod} </p>
