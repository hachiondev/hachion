...
// };
    ...
    useEffect(() => {
      const fetchCourse = async () => {
          try {
              const response = await axios.get('http://160.153.175.69:8080/HachionUserDashboad/trendingcourse');
    ...
    const handleDeleteConfirmation = (trendingcourse_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `http://160.153.175.69:8080/HachionUserDashboad/trendingcourse/update/${editedData.trendingcourse_id}`,editedData
            );
      ...
      const handleDelete = async (trendingcourse_id) => {
         ...
         try { 
          const response = await axios.delete(`http://160.153.175.69:8080/HachionUserDashboad/trendingcourse/delete/${trendingcourse_id}`); 
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post("http://160.153.175.69:8080/HachionUserDashboad/trendingcourse/add", dataToSubmit);
