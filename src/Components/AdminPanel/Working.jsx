  ...
  const [searchTerm,setSearchTerm]=useState("")
    ...
    const handleDeleteConfirmation = (faq_id) => {
      ...
      const handleDelete = async (faq_id) => {
         ...
         try { 
          const response = await axios.delete(`https://api.test.hachion.co/faq/delete/${faq_id}`); 
...
//     try {
//         const response = await axios.post("https://api.test.hachion.co/curriculum/add", dataToSubmit, {
//             headers: {
