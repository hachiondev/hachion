  ...
  const handleBulkDelete = async () => {
    ...
    if (window.confirm(confirmMessage)) {
      try {
        ...
        // Update state
        const updatedCourses = allCourses.filter(item => !selectedIds.includes(item.id));
        setAllCourses(updatedCourses);
        setFilteredCourses(updatedCourses);
        setCategories(updatedCourses);
                ...
                <div className="course-row">
                  ...
                  <div className="col-md-4">
                    ...
                    <input
                      ...
                      required
                    />
                    {shortCourseError && <div style={{ color: "red" }}>{shortCourseError}</div>}
                  </div>
                </div>
                <div className="course-row">
                  <div className="col-md-4">
                ...
                <Table sx={{ minWidth: 700 }}>
                  ...
                  <TableBody>
                    {displayedCategories.length > 0 ? displayedCategories.map((course, idx) => (
                      ...
                      <StyledTableRow>
                        {/* UPDATED: Changed colSpan from 6 to 8 to include checkbox column */}
