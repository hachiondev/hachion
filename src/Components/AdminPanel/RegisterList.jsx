...
const [currentPage, setCurrentPage] = useState(1);
    ...
    useEffect(() => {
      const fetchStudent = async () => {
          try {
              const response = await axios.get('/HachionUserDashboad/registerstudent');
    ...
    const handleDeleteConfirmation = (student_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `/HachionUserDashboad/registerstudent/update/${editedData.student_id}`,editedData
            );
      ...
      const handleDelete = async (student_id) => {
         ...
         try { 
          const response = await axios.delete(`/HachionUserDashboad/registerstudent/delete/${student_id}`); 
  ...
  password: studentData.password || null
        ...
        try {
          const response = await axios.post("/HachionUserDashboad/registerstudent/add", dataToSubmit);
