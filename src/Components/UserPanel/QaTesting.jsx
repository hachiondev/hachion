        ...
        return (
          <>
            <div className="video-card">
              <iframe
                src="https://www.youtube.com/embed/VIDEO_ID_1" // Replace VIDEO_ID_1 with actual YouTube video ID
              ...
              <div className="video-card-content">
                ...
                <p className="video-description">
                  A comprehensive guide to QA Automation techniques.
                </p>
              </div>
            </div>
            ...
            <div className="video-card">
              <iframe
                src="https://www.youtube.com/embed/VIDEO_ID_2" // Replace VIDEO_ID_2 with actual YouTube video ID
              ...
              <div className="video-card-content">
                <p className="video-title">
                  Introduction to Automation Testing Video
                </p>
                <p className="video-description">
                  Learn the basics of automation testing with real examples.
                </p>
              </div>
            </div>
          </>
    ...
    <>
      ...
      <div className="blog">
        ...
        <div className="blog-batch-type">
          <p
            className={`blog-batch-type-content ${
              selectedBatchType === "Publications" ? "active" : ""
            }`}
          ...
          <p
            className={`blog-batch-type-content ${
              selectedBatchType === "Interview Questions" ? "active" : ""
            }`}
          ...
          <p
            className={`blog-batch-type-content ${
              selectedBatchType === "FAQ's" ? "active" : ""
            }`}
          ...
          <p
            className={`blog-batch-type-content ${
              selectedBatchType === "Videos" ? "active" : ""
            }`}
