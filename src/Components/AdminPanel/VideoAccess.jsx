...
// };
    ...
    useEffect(() => {
      const fetchCourse = async () => {
          try {
              const response = await axios.get('/HachionUserDashboad/trendingcourse');
    ...
    const handleDeleteConfirmation = (trendingcourse_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `/HachionUserDashboad/trendingcourse/update/${editedData.trendingcourse_id}`,editedData
            );
      ...
      const handleDelete = async (trendingcourse_id) => {
         ...
         try { 
          const response = await axios.delete(`/HachionUserDashboad/trendingcourse/delete/${trendingcourse_id}`); 
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post("/HachionUserDashboad/trendingcourse/add", dataToSubmit);
