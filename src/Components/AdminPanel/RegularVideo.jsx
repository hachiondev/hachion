  ...
  const [filterCourse,setFilterCourse]=useState([]);
    ...
    useEffect(() => {
      const fetchVideo = async () => {
          try {
              const response = await axios.get('/HachionUserDashboad/regularvideo');
    ...
    const handleDeleteConfirmation = (regularvideo_id) => {
      ...
      const handleSave = async () => {
        try {
            const response = await axios.put(
                `/HachionUserDashboad/regularvideo/update/${editedRow.regularvideo_id}`,
                editedRow
            );
      ...
      const handleDelete = async (regularvideo_id) => {
         ...
         try { 
          const response = await axios.delete(`/HachionUserDashboad/regularvideo/delete/${regularvideo_id}`); 
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post("/HachionUserDashboad/regularvideo/add", dataToSubmit);
