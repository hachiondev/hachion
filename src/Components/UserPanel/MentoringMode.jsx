...
const MentoringMode = () => {
  ...
  const anotherTargetAudience =
    "Career Transitioners, Struggling students, Advances Learners, Specialized Skill Seekers, Working Professionals, Project-Based Learners, Self-Placed Learners.";

  const anotherFeatures = [
    [
      {
        icon: image1,
        content: "Downloadable recorder videos after every session",
      },
      {
        icon: image2,
