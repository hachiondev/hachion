              ...
              {displayedCourse.length > 0 ? (
                displayedCourse.map((row, index) => (
                  <StyledTableRow key={row.student_id}>
                    ...
                    <StyledTableCell align="center">
                      {" "}
                      <MdOutlineRemoveRedEye onClick={handleViewDemo} />{" "}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      <MdOutlineRemoveRedEye onClick={handleViewClass} />
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      <MdOutlineRemoveRedEye onClick={handleViewMentoring} />
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      <MdOutlineRemoveRedEye onClick={handleViewSelfPlaced} />
                    </StyledTableCell>
                  </StyledTableRow>
                ))
              ) : (
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item">
                      <a href="#!" onClick={() => setShowDemoTable(false)}>
                        Student Details
                      </a>{" "}
