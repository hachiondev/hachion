...
export default function RegularVideo() {
  ...
  const handleSave = async () => {
    try {
      ...
      setRegularVideo((prev) =>
        prev.map((curr) =>
          curr.regularvideo_id === editedRow.regularvideo_id
            ? response.data
            : curr
        )
      );
  ...
  useEffect(() => {
    const filtered = regularVideo.filter(
      (regularVideo) =>
        regularVideo.course_name
          .toLowerCase()
          .includes(searchTerm.toLowerCase()) ||
        regularVideo.category_name
          .toLowerCase()
          .includes(searchTerm.toLowerCase()) ||
        regularVideo.video_description
          .toLowerCase()
          .includes(searchTerm.toLowerCase()) ||
        regularVideo.video_duration
          .toLowerCase()
          .includes(searchTerm.toLowerCase()) ||
    ...
    <>
                      ...
                      <StyledTableCell align="center">
                        ...
                        >
                          ...
                          <RiDeleteBin6Line
                            className="delete"
                            onClick={() =>
                              handleDeleteConfirmation(row.regularvideo_id)
                            }
                          />
                        </div>
                      </StyledTableCell>
      ...
      >
        <div className="dialog-title">
          <DialogTitle id="edit-schedule-dialog">
            Edit Regular Video
          </DialogTitle>
